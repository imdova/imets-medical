        ...
        <div className="relative border-t border-gray-200 py-7">
          <div className="flex flex-col items-center justify-center lg:flex-row lg:justify-between">
            ...
            <div className="mt-4 flex space-x-4 sm:justify-center lg:mt-0">
              <Link
                href="javascript:;"
                className="flex h-8 w-8 items-center justify-center rounded-full bg-orange-primary transition-all duration-500 hover:bg-black"
              >
                <svg
              ...
              <Link
                href="javascript:;"
                className="relative flex h-8 w-8 items-center justify-center rounded-full bg-orange-primary transition-all duration-500 hover:bg-black"
              >
                <svg
