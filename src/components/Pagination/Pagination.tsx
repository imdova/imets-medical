    ...
    <nav>
      <ul className="pagination flex justify-center gap-2 my-3">
        {pageNumbers.map((number) => (
          <li key={number}>
            <button
              className={`page-item flex justify-center items-center w-10 h-10 text-xs cursor-pointer text-gray-500 border hover:border-orange-primary hover:text-primary rounded-lg ${
                currentPage === number ? "bg-orange-primary !text-white" : ""
              }`}
