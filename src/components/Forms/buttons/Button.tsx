...
const Button: React.FC<ButtonProps> = ({
  ...
  const colorStyles: Record<ButtonColor, Record<ButtonVariant, string>> = {
    primary: {
      contained:
        "hover:bg-yellow-600/60 focus:ring-orange-primary rounded-md bg-orange-primary px-4 py-2 font-medium text-white shadow-simple transition-all duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2",
      outlined:
        "hover:bg-gray-200 focus:ring-orange-primary rounded-md border px-4 py-2 font-medium text-black shadow-simple transition-all duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2",
    },
    warning: {
      contained:
