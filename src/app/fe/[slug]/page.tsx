...
import { freeEventLandingPagesData } from "@/constants/events-landing-page.data";
import FreeEventLandingApply from "./freeEvent-landing-apply";
...
const Page = async ({
  ...
  const page = freeEventLandingPagesData.find((page) => page.slug === slug);
